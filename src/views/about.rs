...
use gpui::{App, Bounds, Window, WindowBounds, WindowKind, WindowOptions, prelude::*, px, size};
        ...
        v_flex()
            ...
            .child(
                h_flex().items_center().justify_center().child(
                    Icon::new(CustomIconName::Logo)
                        .size(px(64.))
                        .text_color(cx.theme().primary),
                ),
            )
            .child(Label::new("Tide").text_xl())
            .child(
            ...
            .child(
                Label::new(format!("© {years} Yunis du. All rights reserved."))
                    .text_xs()
                    .text_color(cx.theme().muted_foreground),
            )
    }
